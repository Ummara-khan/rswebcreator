          ...
          >
            ...
            >
              ...
              <div style={{ width: "100%", maxWidth: "1100px" }}>
                ...
                {/* Paragraph — indented to align under "TO IMPACT" offset */}
                <div
                  style={{
                    paddingLeft: "230px",
                    marginTop: "20px",
                ...
                >
                  ...
                  >
                    From standout logo designs to dynamic websites, animations,
                    and apps — we blend creativity with strategy to elevate your
                    brand. Our expert team delivers impactful solutions in web
                    development, branding, social media, SEO, and more —
            ...
            >
              {/* Sphere image — positioned top-right, overlapping card */}
              <img
              ...
              >
                {/* Spacer so text sits below sphere area */}
          ...
          >
            ...
            <div style={{ maxWidth: "650px" }}>
              ...
              >
                ...
                experiences. From cutting-edge websites to bold brand
                identities, we craft creative solutions that drive results.
              </p>
              ...
              >
                With a passion for design and a focus on strategy, we help
                businesses stand out, grow, and stay ahead in the digital world.
              </p>
            </div>
      ...
      >
        ...
        >
          {[
            {
              title: "Logo Design",
              desc: "We craft bold, memorable logos that capture your brand’s essence and spark instant recognition across every platform.",
              icon: "/assets/logo-icon.png",
            },
            {
              title: "SMM & SEO",
              desc: "We grow your brand with smart SEO and social media that connect, engage, and convert audiences.",
              icon: "/assets/smm-icon.png",
            },
            {
              title: "Web & App Development",
              desc: "Building high-performance digital products tailored to your needs.",
              icon: "/assets/web-icon.png",
            },
            {
              title: "Animations",
              desc: "Bringing your ideas to life with stunning motion graphics and visuals.",
              icon: "/assets/anim-icon.png",
            },
          ].map((service, index) => {
          ...
          >
            ...
            >
              ...
              <div style={{ flex: "1.2", minWidth: "400px" }}>
                ...
                >
                  Explore our latest digital masterpieces — a fusion of bold
                  aesthetics, smart builds, and creative strategies tailored for
                  impact.
                </p>
                ...
                >
                  <div
                    style={{
                      width: "140px",
                      height: "140px", // Increased circle size
                      border: "1px solid rgba(255,255,255,0.2)",
                      borderRadius: "50%",
                      display: "flex",
                      alignItems: "center",
      ...
      >
        ...
        >
          ...
          <div style={{ flex: "1", minWidth: "400px" }}>
            ...
            >
              Trusted by leading brands that prioritize creativity, demand
              consistency, and seek impactful results that drive meaningful
              success.
            </p>
          </div>
